...
bp_main : dialog {
  ...
  :boxed_column { label = "图框识别";
    ...
    :row {
      ...
      :toggle { key = "auto_rotate"; label = "自动旋转"; value = "1"; }
      :toggle { key = "auto_center"; label = "自动居中"; value = "1"; }
    }
  }
  ...
  :boxed_column { label = "打印设置";
    ...
    :row {
      :column {
        :popup_list { key = "paper"; label = "纸张:"; width = 16; }
      }
      :column {
  ...
  :boxed_column { label = "输出设置";
    :row {
      :column {
        :popup_list { key = "output_mode"; label = "输出方式:"; width = 16; }
      }
      :column {
    ...
    :row {
      :column {
        :edit_box { key = "name_rule"; label = "文件命名规则:"; width = 28; }
      }
      :column {
  ...
  :boxed_column { label = "图纸列表";
    :row {
      ...
      :column {
        ...
        :button { key = "btn_sort_x"; label = "X排序"; width = 12; fixed_width = true; }
        :button { key = "btn_sort_y"; label = "Y排序"; width = 12; fixed_width = true; }
    ...
    :row {
      :text { key = "status"; label = "就绪。点击「检测图框」开始。"; }
    }
  }
